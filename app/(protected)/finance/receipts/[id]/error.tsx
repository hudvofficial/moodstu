...
export default function ReceiptDetailError({ error, reset }: ErrorProps) {
  return (
    <div className="main-container">
      <div className="card-base flex flex-col items-center gap-4 p-10 text-center">
        ...
        <div>
          <h2 className="text-h2">Không thể tải phiếu thu</h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/finance/receipts" className="btn-primary">
            Về Phiếu thu
          </Link>
        </div>
      </div>
