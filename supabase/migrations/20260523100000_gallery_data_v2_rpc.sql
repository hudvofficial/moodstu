-- ============================================================================
-- Gallery Data V2 RPC
-- Combines 3 sequential requests into 1 for gallery page load optimization
-- ============================================================================
...
BEGIN
  ...
  SELECT jsonb_agg(
    jsonb_build_object(
      ...
      'drive_thumbnail_url', gi.drive_thumbnail_url,
...
'Optimized gallery data fetch - combines images, reactions, comments, albums in single call';
