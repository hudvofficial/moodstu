-- R2 (#12) — hoàn tiền không phải chi phí · T-20260907-r2-ledger-hoan-tien.spec.md
-- Sinh từ thân hàm SỐNG dump 2026-09-07 (agent/HANDOFFS/T-20260907-r2-ledger-hoan-tien.revert.sql là bản quay lui).
-- Thay đổi DUY NHẤT: loại phiếu chi danh mục contract_refund/refund/hoan_tien khỏi cost_direct (sổ kỳ) và direct_cost (từng HĐ).
-- Không đổi chữ ký hàm, không đổi cash_out.
