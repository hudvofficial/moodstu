-- ============================================================================
-- Gallery Data V2 Dynamic Pagination - Fix hard-coded LIMIT 200
-- Issue: Original RPC only loads first 200 images, breaking pagination
-- Solution: Add p_limit and p_offset parameters for dynamic pagination
-- ============================================================================

CREATE OR REPLACE FUNCTION get_gallery_data_v2(
  p_gallery_id uuid,
...
GRANT EXECUTE ON FUNCTION get_gallery_data_v2(uuid, integer, integer) TO authenticated;

COMMENT ON FUNCTION get_gallery_data_v2(uuid, integer, integer) IS
'Optimized gallery data fetch with dynamic pagination. Combines images, reactions, comments, albums in single call. Supports configurable limit/offset for infinite scroll.';
