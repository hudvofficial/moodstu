CREATE OR REPLACE FUNCTION public.moodie_jsonb_cosine_similarity(a JSONB, b JSONB)
...
GRANT EXECUTE ON FUNCTION public.moodie_jsonb_cosine_similarity(JSONB, JSONB) TO authenticated, service_role;

COMMENT ON FUNCTION public.match_moodie_memories IS
  'RLS-scoped database-native hybrid memory retrieval over semantic JSON embeddings, lexical rank, scope, importance and recency.';
