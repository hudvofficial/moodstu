-- 3a. finance_dashboard_metrics — fix receipts soft-delete
...
-- 3b. finance_revenue_by_month — fix receipts CTE soft-delete
...
-- 3c. finance_ledger — fix receipts UNION ALL block soft-delete
