CREATE OR REPLACE FUNCTION public.add_fulfillment_transaction_atomic(
  p_parent_txn_id uuid,
  p_new_item_id uuid,
  p_quantity integer,
  ...
  IF v_total_amount > 0 THEN
    ...
    ELSE
      ...
      INSERT INTO public.receipts (
        ...
        v_total_amount, 'Thu tiền in bổ sung phát sinh', '', 'Bán vật tư',
...
GRANT EXECUTE ON FUNCTION public.add_fulfillment_transaction_atomic(uuid, uuid, integer, numeric, public.payment_method_enum, date, uuid) TO service_role;
REVOKE ALL ON FUNCTION public.add_fulfillment_transaction_atomic(uuid, uuid, integer, numeric, public.payment_method_enum, date, uuid) FROM PUBLIC, anon, authenticated;
