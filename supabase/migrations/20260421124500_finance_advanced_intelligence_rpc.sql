...
BEGIN
  ...
  v_scenarios := jsonb_build_array(
    jsonb_build_object(
      ...
      'nextMonthProfit', ROUND(v_monthly_profit * 0.70, 0),
      'threeMonthRevenue', ROUND(v_monthly_revenue * 0.85 * 3, 0),
      'threeMonthProfit', ROUND(v_monthly_profit * 0.70 * 3, 0),
    ...
    jsonb_build_object(
      ...
      'nextMonthProfit', ROUND(v_monthly_profit * 1.30, 0),
      'threeMonthRevenue', ROUND(v_monthly_revenue * 1.20 * 3, 0),
      'threeMonthProfit', ROUND(v_monthly_profit * 1.30 * 3, 0),
