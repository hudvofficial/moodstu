-- Single-call contract list payload for /contracts.
-- Keeps the response shape compatible with the current React table while
-- removing the separate customer search + work task + checklist round-trips.
