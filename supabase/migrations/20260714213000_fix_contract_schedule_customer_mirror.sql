-- Restore the canonical save_contract_atomic definition in environments where
-- an older function body drifted back into production. This keeps customer
-- identity fields and the primary wedding date mirrored atomically with save.
