            ...
            <main
              ...
              isFullpage
                ...
                : isChatView
                  ? "p-0"
                : isAppView
                  ? "px-0 max-lg:pt-[calc(3.5rem+env(safe-area-inset-top))] lg:pt-0 max-lg:pb-[calc(3.75rem+max(0.5rem,env(safe-area-inset-bottom)))] md:px-6 md:py-6 lg:px-6 lg:pb-6"
                : isFormPage
                  ...
                  : isGalleryView
                    ...
                    : "px-2 max-lg:pt-[calc(3.5rem+env(safe-area-inset-top))] lg:pt-0 max-lg:pb-[calc(3.75rem+max(0.5rem,env(safe-area-inset-bottom)))] md:px-6 md:py-6 lg:px-6 lg:pb-6",
