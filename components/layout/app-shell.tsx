            ...
            <main
              ...
              isFullpage
                ...
                : isChatView
                  ? "p-0"
                : isAppView
                  ? "px-0 max-lg:pt-[calc(3.5rem+env(safe-area-inset-top))] lg:pt-0 md:px-6 md:py-6 lg:px-6 lg:pb-6"
                : isFormPage
                  ...
                  : isGalleryView
                    ...
                    : "px-2 max-lg:pt-[calc(3.5rem+env(safe-area-inset-top))] lg:pt-0 pb-4 md:px-6 md:py-6 lg:px-6 lg:pb-6",
