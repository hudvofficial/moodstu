      ...
      phone={
        <div className="space-y-3">
          <div className="flex flex-nowrap items-center gap-2 overflow-x-auto scrollbar-hide">
            ...
            <SelectPill value={position} onChange={onPositionChange} options={positionOptions} placeholder="Vị trí" />
            <SelectPill value={role} onChange={onRoleChange} options={roleOptions} placeholder="Loại" />
            <SelectPill value={sort} onChange={onSortChange} options={sortOptions} placeholder="Sắp xếp" defaultValue="default" />
            <SelectPill value={month} onChange={onMonthChange} options={monthOptions} placeholder="Tháng" />
            <SelectPill value={year} onChange={onYearChange} options={yearOptions} placeholder="Năm" />
          </div>
          {hasActiveFilters ? (
