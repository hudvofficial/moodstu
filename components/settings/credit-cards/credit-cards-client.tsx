...
export default function CreditCardsClient({
    ...
    const onSuccess = () => {
        router.refresh();
        // In a sophisticated app, we should refetch the data or optimistically update,
        // but Next.js router.refresh() will re-trigger the Server Component to pass new props.
        // For immediate UI update until refresh finishes:
        setTimeout(() => {
        ...
        <div className="space-y-6">
            ...
            {(!cards || !Array.isArray(cards) || cards.length === 0) ? (
                <div className="text-center py-20 border border-dashed border-border-base rounded-2xl">
                    ...
                    <h3 className="text-sm font-semibold text-text-primary">Không có thẻ tín dụng</h3>
                            ...
                            <div className="p-4 bg-bg-card space-y-3">
                                <div className="flex items-center text-sm">
                                    ...
                                    <span className="font-medium text-text-primary">
                                        {card.credit_limit
                                            ? new Intl.NumberFormat("vi-VN").format(card.credit_limit) + " đ"
                                            : "Không giới hạn"}
                                    </span>
                                </div>
                                ...
                                <div className="flex items-center text-sm">
                                    ...
                                    <span className="text-text-secondary w-28">Sao kê / T.Toán:</span>
                                    <span className="font-medium text-text-primary">
