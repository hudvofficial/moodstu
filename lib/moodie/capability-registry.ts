...
export const MOODIE_CAPABILITIES: Record<string, MoodieCapability> = {
  ...
  browse_page: { name: "browse_page", label: "Đọc trang web", surfaces: ["text"], domains: ["general", "codebase"], minimumRoles: ALL_ROLES, boundary: "external", sideEffect: "none", confirmation: "never", executionMode: "foreground", requiresData: true, readOnly: true, priority: 114, expectsSources: true },
