...
- **Sau merge (user "merge + push" 27/08):** ff `b1f0cc8 → 72617f8`, Vercel lên sau 3,5 phút, `inventory-contract-sale` prod **3/3**, seed sạch (3 vật tư, 9 giao dịch thật nguyên).
