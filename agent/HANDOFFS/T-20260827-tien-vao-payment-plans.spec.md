...
- **Sau merge (user "merge + push" 27/08):** ff `381b898 → 6405ec6`, Vercel lên sau 3,5 phút, `cashflow-m3` prod **3/3** (dashboard "Đã giao chưa thu" đúng), seed sạch; prod: 121 mốc, phải thu đến hạn 3.300.000, 35 phiếu chi.
