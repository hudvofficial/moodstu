...
3. **Production** sau merge `334b947` (Vercel deploy xong sau 193s): bộ chỉ-đọc trên `stu.moodwedding.com` **8/8 PASS** (AC1/2/3/7 + AC5c Slow 3G). **AC6** — probe tab ĐÃ CHỌN sau deploy: Lệ–Vũ **160** (trước 160), Xuân Phúc **40** (trước 40 — vẫn kẹt y nguyên, đúng kỳ vọng "không đụng"), Huyền–Vinh **9** (trước 9) → hành vi tab cũ không đổi.
