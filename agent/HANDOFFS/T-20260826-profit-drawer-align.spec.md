...
| Production | **MERGED main `63a48bf → 2fa2d97`** (ff, user "ok merge + push"); Vercel lên bình thường (~5 phút). **Playwright `cashflow-m2` trên `stu.moodwedding.com`: 3/3 PASS** — drawer lợi nhuận và drawer vận hành cùng width 480, nội dung mới hiện đúng (ngày chụp, Thợ ngoài, +3.500.000). Seed dọn sạch (E2E 0, expenses 35, phải trả 1.905.000). |
