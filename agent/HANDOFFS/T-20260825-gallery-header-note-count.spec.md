...
3. Ảnh chụp header @375/@768/@1024 + view-only lưu ở scratchpad phiên (không đưa vào repo). Ảnh `test-375.png` chụp ra nền trơn (race lúc chụp), nhưng 3 assertion DOM @375 của gallery test đều PASS và ảnh `real-375.png` xác nhận layout 4 chip @375 bằng mắt.
