...
> Cập nhật gần nhất: **2026-08-25** · nhánh: `main` @ `78a4fb5`.

## 2026-08-25 (tiếp #4) — gallery khách: M2 tab GHI CHÚ — SPEC CHỜ DUYỆT · phát hiện tab ĐÃ CHỌN lọc thiếu
...
- **T-20260825-gallery-noted-tab: status = `spec`** — locks `gallery-reaction-actions.ts` + `public-gallery-client.tsx`. Spec có code trước/sau từng chỗ, AC4 (✓/❤️ trên ảnh ngoài trang đã tải, gallery E2E 172 ảnh + note ở #150), AC6 (probe tab ĐÃ CHỌN trước/sau phải y hệt).
